# from "Data Mining INFS348-FALL2023" 
#
#######################################################################
...
table(credit_test$default, credit_boost_pred10)

install.packages("randomForest")
library(randomForest)

n_trees <- 100  # You can change this to the desired number of trees
credit_rf_model <- randomForest(credit_train[-17], credit_train$default, ntree = n_trees)

credit_rf_model

credit_rf_pred <- predict(credit_rf_model, credit_test)
table(credit_test$default, credit_rf_pred)
